<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TDorados.aspx.cs" Inherits="Ejercicios.TDorados" %>
         ...
         <div class="grilla form-row text-white">
             <div class="col-md-12 ">
                 <div class="table-responsive justify-content-center align-items-center">
                     <h3 class="text-center bg-success text-white p-3">Dorados</h3>
