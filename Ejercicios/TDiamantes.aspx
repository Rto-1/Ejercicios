<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TDiamantes.aspx.cs" Inherits="Ejercicios.TDiamantes" %>
         ...
         <div class="grilla form-row text-white">
             <div class="col-md-12 ">
                 <div class="table-responsive justify-content-center align-items-center">
                     <h3 class="text-center text-white p-3">Diamantes
                     </h3>
