<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TPInfantil.aspx.cs" Inherits="Ejercicios.TPInfantil" %>
         ...
         <div class="grilla form-row text-white">
             <div class="col-md-12 ">
                 <div class="table-responsive justify-content-center align-items-center">
                     <h3 class="text-center text-white p-3">Primera Infantil
                     </h3>
